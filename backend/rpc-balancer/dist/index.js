...
exports.manager = exports.app = void 0;
const express_1 = __importDefault(require("express"));
const pino_1 = __importDefault(require("pino"));
const upstream_1 = require("./upstream");
require("dotenv/config");
const logger = (0, pino_1.default)({ name: 'rpc-balancer' });
// --- Configuration ---
...
const manager = new upstream_1.UpstreamManager(upstreams);
...
async function handleSingleRequest(rpcReq) {
